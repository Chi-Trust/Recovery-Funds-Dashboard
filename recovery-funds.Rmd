...
p <- ggplot(budget_gap_filter, aes(x = budget_to_allocation_gap, y = topic)) +
  geom_col(aes(text = paste("Original allocation: ", allocation, 
                            "<br>Current spending: ", adopted_budget_per_treasury_report, 
                            "<br>Difference between allocation and adopted budget: ", budget_to_allocation_gap,
  ...
  .data |>
    ...
    geom_col(
      mapping = aes(
        x = reorder(topic, pct_expended),
        y = pct_expended,
        text = paste("Original Allocation: ", adopted_budget_per_treasury_report, 
                     "<br>Current Spending: ", total_cumulative_expenditures, 
