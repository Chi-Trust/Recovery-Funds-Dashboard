...
knitr::include_graphics(here::here("www", "images", "CCT_logo_centered_blue-new.jpg") )
```
...
```{r flowchart, echo=FALSE, fig.align='center'}
knitr::include_graphics(here::here("www", "images", "Funding Flows Charts_rec.png"), dpi = 500)
```
